...
import {saveUser,saveCompany ,findUser,saveSalesmen,findCompany} from "../DBRepo/UserModel"; 
...
router.get('/companyDetail/:AdminId', (req: express.Request, res: express.Response) => {
...
router.get('/sminfo/:AdminId', (req: express.Request, res: express.Response) => {
 let AdminId = req.params.AdminId;
console.log(AdminId)
    findCompany({AdminId : AdminId })
        .then((sminfoInstance) => {
